 ...
 */
final class Version20190913222454 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD preferences_id INT DEFAULT NULL, CHANGE password password MEDIUMTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP preferences_id, CHANGE password password MEDIUMTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
